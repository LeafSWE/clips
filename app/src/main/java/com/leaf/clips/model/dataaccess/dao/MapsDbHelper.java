...
public class MapsDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO Building VALUES (0, 'f7826da6-4fa2-4e98-8024-bc5b71e0893e', 666, 'Torre Archimede', 'Mappa già presente in locale tramite le insert di MapsDbHelper.', '07.30 - 19.00. Dal lunedì al venerdì.', 'Via Trieste 63 - 35121 Padova', '1', 'DimensioniMappa')");
