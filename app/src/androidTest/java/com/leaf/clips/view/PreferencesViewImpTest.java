 ...
 *
 * TU143
 * Viene verificato che siano visualizzate le impostazioni per gestire le preferenze
...
@LargeTest
public class PreferencesViewImpTest {
    ...
    @Test
    public void shouldShowPreferencesSettings(){
        Intents.init();
        onView(withId(R.id.drawer_layout_home)).perform(open());
        onView(withId(R.id.nav_view_home)).perform(NavigationViewActions.navigateTo(R.id.settings));
